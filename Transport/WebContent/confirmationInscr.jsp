...
<html>
	...
	<body>
		<div id="bloc_page">
			...
			<nav>
				<h3>Inscription ou modifications effectuées avec succés</h3><br />
				Vous pouvez des a present vous connecter
			</nav>
			...
			<section id="corps">
				<input type="submit" value="Retour à l'acceuil" onclick ="self.location.href='accueil.jsp'">
			</section>
