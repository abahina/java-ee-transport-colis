...
<html>
	...
	<body>
		<div id="bloc_page">
			...
			<section id="corps">
				<p style="text-align:center;"><b>Etes-vous déjà membre?</b></p>
						...
						<tr>
								...
								<table cellSpacing=0 cellPadding=5 border=0>
									...
									<tr>
										<td align="center" colSpan=2>
											<input type="submit" name="formulaire" value="se connnecter"/>
										</td> 
									</tr>
									<tr>
										<td align="left" colSpan=2>
											<a href="demandeIdentifiant.jsp">mot de passe oublie</a>
										</td>
									</tr>
								</table>
							</td>
							<td vAlign=top>
								<table cellSpacing=0 cellPadding=5 border=0>
									...
									<tr>
										<td align="center" colSpan=2>
											<input type="submit" name="formulaire" value="Creer"/>
										</td>
									</tr>
								</table>
							</td>
