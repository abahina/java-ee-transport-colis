...
<html>
	...
	<body>
		<div id="bloc_page">
			...
			<section id="corps">
				Attention vos anciennes données seront perdues. Souhaitez-vous Poursuivre ? <br />
				<form action="/Transport/Controleur" method="get">
					<input type="submit" name="formulaire" value="Oui, je confirme">
				</form>
				<input type="submit" value="Non" onclick="self.location.href='accueilConnecte.jsp'">
			</section>
			<footer>
