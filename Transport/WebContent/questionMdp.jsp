		...
		<div id="bloc_page">
			...
			<form action="/Transport/Controleur" method="get">
				<section id="corps">
					...
					<p><h4> <%= erreur %> </h4></p>
					<% } %>
					<p>Pour récuperer votre mot de passe, veuillez répondre a votre question secrète :</p>
					<p>Question : <%= question %></p>
					<p>Réponse : <input name="reponse" type="text"/></p>
					<p>
						<input type = "submit" name="formulaire" value = "Soumettre"> 
						<input type = "submit" name="formulaire" value = "Accueil">
					</p>
				</section>
			</form>
