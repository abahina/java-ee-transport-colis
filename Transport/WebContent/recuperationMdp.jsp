	...
	<body>
		<div id="bloc_page">
			...
			<form action="/Transport/Controleur" method="get">
				<section id="corps">
					<% 
					Object mdp = request.getAttribute("mdpasse");
					String mdpasse = (String) mdp;
					%>				
					<p>Votre mot de passe actuel est : <h4> <%= mdpasse %> </h4> </p>
					<p><input type = "submit" name="formulaire" value = "Accueil"></p>
				</section>
			</form>
