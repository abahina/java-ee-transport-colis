...
<html>
	...
	<body>
		<div id="bloc_page">
			...
			<nav>
				<h3>Recuperation de votre mot de passe</h3><br />
			</nav>
			...
			<form action="/Transport/Controleur" method="get">
				<section id="corps">
					...
					<p><h4> <%= erreur %> </h4></p>
					<% } %>		
					<p>Identifiant : <input name="identifiant" type="text"/> </p>
					Veuillez entrer votre identifiant pour accéder à votre question secrete et recuperer votre mot de passe
					<p><input type = "submit" name="formulaire" value = "Question"> <input type = "submit" name="formulaire" value = "Accueil"></p>
				</section>
			</form>
